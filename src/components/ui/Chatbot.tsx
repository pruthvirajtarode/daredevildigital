  ...
  return (
    <>
      <button
        ...
        className={`fixed bottom-24 right-4 sm:bottom-24 sm:right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-brand-navy text-brand-purewhite shadow-xl transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-brand-yellow focus:ring-offset-2 ${isOpen ? 'scale-0 opacity-0' : 'scale-100 opacity-100 duration-300'}`}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-4 sm:bottom-24 sm:right-6 z-50 w-[calc(100vw-2rem)] sm:w-96 overflow-hidden rounded-2xl bg-brand-purewhite shadow-2xl border border-brand-charcoal/10 flex flex-col h-[500px] max-h-[80vh]"
          >
            {/* Header */}
